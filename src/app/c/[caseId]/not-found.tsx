...
export default function CaseNotFound() {
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-20 sm:px-8">
      ...
      <Link
        href="/"
        className="mt-8 inline-flex items-center rounded-control bg-primary px-5 py-2.5 text-[0.9375rem] font-semibold text-on-primary transition-transform duration-150 hover:bg-primary-deep active:scale-[0.97]"
      >
        Start a Round
      </Link>
    </main>
